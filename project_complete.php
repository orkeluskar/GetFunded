...
return $connection;
    ...
    $sql="Select * from project where owner_id='$userid' and (status='pledged' or status='complete')";
            ...
            <div class="nav navbar-nav mr-2"> 
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu-right dropdown-menu" >
                            ...
                            <a class="dropdown-item" href="#">complete a project?</a>
