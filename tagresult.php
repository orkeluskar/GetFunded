...
$keyword = mysql_real_escape_string($_POST['usertag']);
$sql = "INSERT INTO taghistory(user_id, tagname, search_date) VALUES('$username','$keyword', now())";

$connection->query($sql);

$sql2 = "SELECT * FROM project WHERE p_tags like '%$keyword%'";
...
<div class="container">
    ...
    <br>
    <h2 style="display:flex; justify-content:center;" class="text-muted">Search (by tag) result</h2>
